...
const FAVORITE_KEY = "wam-paper-hub-favorites";
...
els.exportCsvBtn.addEventListener("click", () => download("wam-papers.csv", toCSV(getFilteredPapers()), "text/csv"));
els.exportBibBtn.addEventListener("click", () => download("wam-papers.bib", getFilteredPapers().map(p => p.bibtex || "").join("\n\n"), "text/plain"));
